...
function registerApplet(self)
	...
	jiveMain:registerSkin(self:string("HD_SKIN_1200_680"),  "HDSkin", "skin_1200_680", "HDSkin-1200-680")
	jiveMain:registerSkin(self:string("HD_SKIN_800_480"),  "HDSkin", "skin_800_480", "HDSkin-800-480")	
	jiveMain:registerSkin(self:string("HD_SKIN_848_480"),  "HDSkin", "skin_848_480", "HDSkin-848-480")	
